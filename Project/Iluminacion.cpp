...
int main()
{
    ...
    // Load models
    Model silla((char*)"C:/Users/cecis/Desktop/ConfigInicial/ConfigInicial/Models/mesasilla.obj");
    ...
    image = stbi_load("Models/plywood_diff_4k.jpg", &textureWidth, &textureHeight, &nrChannels, 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.diffuse"), 0.0f, 0.7f, 0.1f);
        glUniform3f(glGetUniformLocation(lightingShader.Program, "light2.specular"), 0.0f, 0.5f, 0.5f);
        ...
        glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"), 0.5f, 0.2f, 0.4f);
        glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 1.0f);
         ...
         //Draw the loaded model cargamos cubo
       /* glm::mat4 model(1);
        ...
        modelSilla = glm::translate(modelSilla, glm::vec3(0.0f, 0.0f, 0.0f)); 
        modelSilla = glm::scale(modelSilla, glm::vec3(0.5f));	
