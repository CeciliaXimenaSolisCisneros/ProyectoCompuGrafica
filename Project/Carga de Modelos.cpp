...
int main( )
{
    ...
    // Load models
    Model dog((char*)"C:/Users/cecis/Desktop/ConfigInicial/ConfigInicial/Models/RedDog.obj"); //creo variable modelo, carga modelo ubocado en esa direccion
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Draw the loaded model, dibuja primer perro
        glm::mat4 model(1);
        glUniformMatrix4fv(glGetUniformLocation(shader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        dog.Draw(shader);


        //dibuja segundo perro y lo mueve a la derecha
        glm::mat4 model2(1);
